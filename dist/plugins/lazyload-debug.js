(function(win, app) {
    ...
    app.plugin.lazyload = {
        ...
        _getOffset: function(img) {
            var content = app.component.getActiveContent(), cStyle = getComputedStyle(img), offsetHeight = parseFloat(img.getAttribute("height") || img.offsetHeight || cStyle.height);
            offsetParent = img.parentNode, offsetTop = parseFloat(img.offsetTop);
